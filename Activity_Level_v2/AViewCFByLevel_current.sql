-- AViewCFByLevel.sql (MODERN - current version)
-- Reconstructed from screenshots
-- Legacy count: 2650 | Modern count: 1853 | Gap: 797 for GM 251435
...
FROM (
    ...
    FROM (
        SELECT
            ...
            HINFIND                                                     AS HINFIND,
            DECODE(b.segind, 'A', AGEIND, 'C', AGEIND, 'I', AGEIND, 'C') AS AGEIND,
            ...
            DECODE(
                ...
                END),
                0)                                                      AS PYRENT,
            DECODE(b.segind, 'A', PYRIND, 'C', PYRIND, 'I', PYRIND, 0) AS PYRIND,
            ...
            LLCIND                                                      AS LLCIND,
            DECODE(b.segind, 'A', RPTIND, 'C', RPTIND, 'I', RPTIND, 'F') AS RPTIND,
