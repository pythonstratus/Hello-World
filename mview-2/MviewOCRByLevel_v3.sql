...
SELECT /*+ first_rows */
    ...
    als.SWITCHROID(PROID) as PROID,                                          -- 54
    ...
    NVL(DTASSD, TO_DATE('01/01/1900','mm/dd/yyyy')) as CYCMOD2I,            -- 77  -- legacy line 426
    'F' as INSPCIND,                                                         -- 78
    'F' as ERRFDIND,                                                         -- 79
    ' ' as TSACTCD,                                                          -- 80
